...
As the MCP ecosystem matures, databases, cloud services, and IoT devices are all being exposed as AI-callable tools through MCP. This signals the emergence of a native AI integration layer.`}];e.s(["getAllTags",0,function(){let e=new Set;return t.forEach(t=>t.tags.forEach(t=>e.add(t))),Array.from(e)},"getPostsByTag",0,function(e){return t.filter(t=>t.tags.includes(e))},"posts",0,t])},6528,e=>{"use strict";var t=e.i(18050),r=e.i(71645),s=e.i(46932);e.i(47167);var i=e.i(31178),o=e.i(47414),a=e.i(74008),n=e.i(21476),l=e.i(72846),c=r,d=e.i(37806);function u(e,t){if("function"==typeof e)return e(t);null!=e&&(e.current=t)}class p extends c.Component{getSnapshotBeforeUpdate(e){let t=this.props.childRef.current;if((0,l.isHTMLElement)(t)&&e.isPresent&&!this.props.isPresent&&!1!==this.props.pop){let e=t.offsetParent,r=(0,l.isHTMLElement)(e)&&e.offsetWidth||0,s=(0,l.isHTMLElement)(e)&&e.offsetHeight||0,i=getComputedStyle(t),o=this.props.sizeRef.current;o.height=parseFloat(i.height),o.width=parseFloat(i.width),o.top=t.offsetTop,o.left=t.offsetLeft,o.right=r-o.width-o.left,o.bottom=s-o.height-o.top}return null}componentDidUpdate(){}render(){return this.props.children}}function m({children:e,isPresent:s,anchorX:i,anchorY:o,root:a,pop:n}){let l=(0,c.useId)(),h=(0,c.useRef)(null),g=(0,c.useRef)({width:0,height:0,top:0,left:0,right:0,bottom:0}),{nonce:f}=(0,c.useContext)(d.MotionConfigContext),y=function(...e){return r.useCallback(function(...e){return t=>{let r=!1,s=e.map(e=>{let s=u(e,t);return r||"function"!=typeof s||(r=!0),s});if(r)return()=>{for(let t=0;t<s.length;t++){let r=s[t];"function"==typeof r?r():u(e[t],null)}}}}(...e),e)}(h,e.props?.ref??e?.ref);return(0,c.useInsertionEffect)(()=>{let{width:e,height:t,top:r,left:c,right:d,bottom:u}=g.current;if(s||!1===n||!h.current||!e||!t)return;let p="left"===i?`left: ${c}`:`right: ${d}`,m="bottom"===o?`bottom: ${u}`:`top: ${r}`;h.current.dataset.motionPopId=l;let y=document.createElement("style");f&&(y.nonce=f);let b=a??document.head;return b.appendChild(y),y.sheet&&y.sheet.insertRule(`
        ...
        `),()=>{h.current?.removeAttribute("data-motion-pop-id"),b.contains(y)&&b.removeChild(y)}},[s]),(0,t.jsx)(p,{isPresent:s,childRef:h,sizeRef:g,pop:n,children:!1===n?e:c.cloneElement(e,{ref:y})})}let h=({children:e,initial:s,isPresent:i,onExitComplete:a,custom:l,presenceAffectsLayout:c,mode:d,anchorX:u,anchorY:p,root:h})=>{let f=(0,o.useConstant)(g),y=(0,r.useId)(),b=!0,x=(0,r.useMemo)(()=>(b=!1,{id:y,initial:s,isPresent:i,custom:l,onExitComplete:e=>{for(let t of(f.set(e,!0),f.values()))if(!t)return;a&&a()},register:e=>(f.set(e,!1),()=>f.delete(e))}),[i,f,a]);return c&&b&&(x={...x}),(0,r.useMemo)(()=>{f.forEach((e,t)=>f.set(t,!1))},[i]),r.useEffect(()=>{i||f.size||!a||a()},[i]),e=(0,t.jsx)(m,{pop:"popLayout"===d,isPresent:i,anchorX:u,anchorY:p,root:h,children:e}),(0,t.jsx)(n.PresenceContext.Provider,{value:x,children:e})};function g(){return new Map}var f=e.i(64978);let y=e=>e.key||"";function b(e){let t=[];return r.Children.forEach(e,e=>{(0,r.isValidElement)(e)&&t.push(e)}),t}let x=({children:e,custom:s,initial:n=!0,onExitComplete:l,presenceAffectsLayout:c=!0,mode:d="sync",propagate:u=!1,anchorX:p="left",anchorY:m="top",root:g})=>{let[x,v]=(0,f.usePresence)(u),w=(0,r.useMemo)(()=>b(e),[e]),S=u&&!x?[]:w.map(y),C=(0,r.useRef)(!0),T=(0,r.useRef)(w),A=(0,o.useConstant)(()=>new Map),P=(0,r.useRef)(new Set),[I,k]=(0,r.useState)(w),[R,j]=(0,r.useState)(w);(0,a.useIsomorphicLayoutEffect)(()=>{C.current=!1,T.current=w;for(let e=0;e<R.length;e++){let t=y(R[e]);S.includes(t)?(A.delete(t),P.current.delete(t)):!0!==A.get(t)&&A.set(t,!1)}},[R,S.length,S.join("-")]);let E=[];if(w!==I){let e=[...w];for(let t=0;t<R.length;t++){let r=R[t],s=y(r);S.includes(s)||(e.splice(t,0,r),E.push(r))}return"wait"===d&&E.length&&(e=E),j(b(e)),k(w),null}let{forceRender:M}=(0,r.useContext)(i.LayoutGroupContext);return(0,t.jsx)(t.Fragment,{children:R.map(e=>{let r=y(e),i=(!u||!!x)&&(w===R||S.includes(r));return(0,t.jsx)(h,{isPresent:i,initial:(!C.current||!!n)&&void 0,custom:s,presenceAffectsLayout:c,mode:d,root:g,onExitComplete:i?void 0:()=>{if(P.current.has(r)||!A.has(r))return;P.current.add(r),A.set(r,!0);let e=!0;A.forEach(t=>{t||(e=!1)}),e&&(M?.(),j(T.current),u&&v?.(),l&&l())},anchorX:p,anchorY:m,children:e},r)})})};var v=e.i(30179);e.s(["default",0,function(){let[e,i]=(0,r.useState)(""),[o,a]=(0,r.useState)(null),n=(0,r.useMemo)(()=>(0,v.getAllTags)(),[]),l=(0,r.useMemo)(()=>v.posts.filter(t=>{let r=""===e||t.title.toLowerCase().includes(e.toLowerCase())||t.excerpt.toLowerCase().includes(e.toLowerCase())||t.content.toLowerCase().includes(e.toLowerCase()),s=!o||t.tags.includes(o);return r&&s}),[e,o]);return(0,t.jsx)("div",{className:"min-h-screen py-20 px-6",children:(0,t.jsxs)("div",{className:"max-w-4xl mx-auto",children:[(0,t.jsx)(s.motion.h1,{className:"text-5xl font-bold mb-8 bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent",initial:{opacity:0,y:20},animate:{opacity:1,y:0},children:"All Posts"}),(0,t.jsx)(s.motion.div,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{delay:.1},className:"mb-6",children:(0,t.jsxs)("div",{className:"relative",children:[(0,t.jsx)("svg",{className:"absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-500",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,t.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"})}),(0,t.jsx)("input",{type:"text",placeholder:"Search posts...",value:e,onChange:e=>i(e.target.value),className:"w-full pl-12 pr-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/50 transition-all"}),e&&(0,t.jsx)("button",{onClick:()=>i(""),className:"absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 hover:text-white transition-colors",children:"✕"})]})}),(0,t.jsxs)(s.motion.div,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{delay:.15},className:"mb-8 flex flex-wrap gap-2",children:[(0,t.jsx)("button",{onClick:()=>a(null),className:`text-sm px-3 py-1.5 rounded-full transition-all ${!o?"bg-blue-500 text-white":"bg-white/5 text-gray-400 hover:bg-white/10 hover:text-white"}`,children:"All"}),n.map(e=>(0,t.jsx)("button",{onClick:()=>a(o===e?null:e),className:`text-sm px-3 py-1.5 rounded-full transition-all ${o===e?"bg-purple-500 text-white":"bg-white/5 text-gray-400 hover:bg-white/10 hover:text-white"}`,children:e},e))]}),(0,t.jsxs)(s.motion.p,{initial:{opacity:0},animate:{opacity:1},transition:{delay:.2},className:"text-gray-500 text-sm mb-6",children:[l.length," ",1===l.length?"post":"posts"," ",e||o?"found":"total"]}),(0,t.jsx)(x,{mode:"popLayout",children:(0,t.jsx)("div",{className:"space-y-6",children:l.map((e,r)=>(0,t.jsxs)(s.motion.a,{href:`/my-app/posts/${e.slug}`,layout:!0,initial:{opacity:0,x:-20},animate:{opacity:1,x:0},exit:{opacity:0,x:20},transition:{delay:.05*r,duration:.3},className:"block group relative overflow-hidden rounded-xl border border-white/10 bg-white/5 p-6 hover:border-blue-500/50 transition-all",whileHover:{x:10},children:[(0,t.jsx)("div",{className:"absolute inset-0 bg-gradient-to-r from-blue-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"}),(0,t.jsxs)("div",{className:"relative flex justify-between items-start",children:[(0,t.jsxs)("div",{children:[(0,t.jsx)("div",{className:"flex gap-2 mb-3",children:e.tags.map(e=>(0,t.jsx)("span",{className:"text-xs px-2 py-1 rounded-full bg-purple-500/20 text-purple-300",children:e},e))}),(0,t.jsx)("h2",{className:"text-2xl font-semibold mb-2 group-hover:text-blue-400 transition-colors",children:e.title}),(0,t.jsx)("p",{className:"text-gray-400",children:e.excerpt})]}),(0,t.jsx)("span",{className:"text-gray-500 text-sm whitespace-nowrap ml-4",children:e.date})]})]},e.slug))})}),0===l.length&&(0,t.jsxs)(s.motion.div,{initial:{opacity:0},animate:{opacity:1},className:"text-center py-20",children:[(0,t.jsx)("p",{className:"text-gray-500 text-lg mb-2",children:"No posts found"}),(0,t.jsx)("p",{className:"text-gray-600",children:"Try a different search term or tag filter"})]})]})})}],6528)}]);