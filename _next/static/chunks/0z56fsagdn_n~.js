...
The protocol has graduated from experimental to essential. Make sure your stack reflects that.`}];e.s(["getAllTags",0,function(){let e=new Set;return t.forEach(t=>t.tags.forEach(t=>e.add(t))),Array.from(e)},"getPostsByTag",0,function(e){return t.filter(t=>t.tags.includes(e))},"posts",0,t])},62028,e=>{"use strict";var t=e.i(18050),a=e.i(71645),i=e.i(30179);e.s(["SearchDialog",0,function(){let[e,r]=(0,a.useState)(!1),[n,o]=(0,a.useState)(""),[s,l]=(0,a.useState)([]),c=(0,a.useRef)(null),d=(0,a.useCallback)(e=>{o(e),l(function(e){if(!e.trim())return[];let t=e.toLowerCase().split(/\s+/).filter(Boolean),a=[];for(let e of i.posts){let i=0,r=e.title.toLowerCase(),n=e.excerpt.toLowerCase(),o=e.content.toLowerCase(),s=e.tags.map(e=>e.toLowerCase());for(let e of t)r.includes(e)&&(i+=10),s.some(t=>t.includes(e))&&(i+=7),n.includes(e)&&(i+=4),o.includes(e)&&(i+=1);i>0&&a.push({...e,score:i})}return a.sort((e,t)=>t.score-e.score).slice(0,8)}(e))},[]);return((0,a.useEffect)(()=>{let e=e=>{(e.metaKey||e.ctrlKey)&&"k"===e.key&&(e.preventDefault(),r(!0)),"Escape"===e.key&&(r(!1),o(""),l([]))};return window.addEventListener("keydown",e),()=>window.removeEventListener("keydown",e)},[]),(0,a.useEffect)(()=>{e&&setTimeout(()=>c.current?.focus(),100)},[e]),e)?(0,t.jsxs)("div",{className:"fixed inset-0 z-[100] flex items-start justify-center pt-[15vh]",children:[(0,t.jsx)("div",{className:"absolute inset-0 bg-black/70 backdrop-blur-sm",onClick:()=>{r(!1),o(""),l([])}}),(0,t.jsxs)("div",{className:"relative w-full max-w-xl mx-4 bg-gray-900 border border-white/10 rounded-2xl shadow-2xl overflow-hidden",children:[(0,t.jsxs)("div",{className:"flex items-center gap-3 px-4 py-3 border-b border-white/10",children:[(0,t.jsx)("svg",{className:"w-5 h-5 text-gray-400 flex-shrink-0",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,t.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"})}),(0,t.jsx)("input",{ref:c,type:"text",value:n,onChange:e=>d(e.target.value),placeholder:"Search posts by title, tag, or keyword...",className:"flex-1 bg-transparent text-white placeholder-gray-500 outline-none text-base"}),(0,t.jsx)("button",{onClick:()=>{r(!1),o(""),l([])},className:"px-2 py-1 text-xs text-gray-400 bg-white/10 rounded-md hover:bg-white/20 transition-colors",children:"ESC"})]}),(0,t.jsx)("div",{className:"max-h-[400px] overflow-y-auto",children:""===n.trim()?(0,t.jsxs)("div",{className:"px-4 py-8 text-center text-gray-500",children:[(0,t.jsxs)("p",{className:"text-sm",children:["Type to search through ",i.posts.length," articles"]}),(0,t.jsx)("p",{className:"text-xs mt-1 text-gray-600",children:"Search by title, tags, or content keywords"})]}):0===s.length?(0,t.jsx)("div",{className:"px-4 py-8 text-center text-gray-500",children:(0,t.jsx)("p",{className:"text-sm",children:"No results found"})}):(0,t.jsx)("div",{className:"py-2",children:s.map(e=>(0,t.jsx)("a",{href:`/my-app/posts/${e.slug}`,className:"block px-4 py-3 hover:bg-white/5 transition-colors",onClick:()=>{r(!1),o(""),l([])},children:(0,t.jsxs)("div",{className:"flex items-start justify-between gap-2",children:[(0,t.jsxs)("div",{className:"flex-1 min-w-0",children:[(0,t.jsx)("h4",{className:"text-white font-medium truncate",children:e.title}),(0,t.jsx)("p",{className:"text-sm text-gray-400 mt-0.5 line-clamp-1",children:e.excerpt}),(0,t.jsxs)("div",{className:"flex items-center gap-2 mt-1.5",children:[(0,t.jsx)("span",{className:"text-xs text-gray-500",children:e.date}),e.tags.slice(0,3).map(e=>(0,t.jsx)("span",{className:"text-xs px-1.5 py-0.5 rounded bg-blue-500/10 text-blue-400",children:e},e))]})]}),(0,t.jsx)("svg",{className:"w-4 h-4 text-gray-600 flex-shrink-0 mt-1",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,t.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})]})},e.slug))})}),(0,t.jsxs)("div",{className:"px-4 py-2 border-t border-white/10 flex items-center justify-between text-xs text-gray-600",children:[(0,t.jsx)("span",{children:s.length>0?`${s.length} results`:""}),(0,t.jsx)("span",{children:"Nitrogen Search"})]})]})]}):(0,t.jsxs)("button",{onClick:()=>r(!0),className:"flex items-center gap-2 px-3 py-1.5 rounded-lg border border-white/10 bg-white/5 hover:bg-white/10 transition-colors text-gray-400 text-sm",title:"Search (Ctrl+K)",children:[(0,t.jsx)("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,t.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"})}),(0,t.jsx)("span",{className:"hidden sm:inline",children:"Search..."}),(0,t.jsx)("kbd",{className:"hidden sm:inline-flex items-center gap-1 px-1.5 py-0.5 text-xs bg-white/10 rounded border border-white/10",children:"Ctrl+K"})]})}])}]);