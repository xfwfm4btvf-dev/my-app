...
For existing applications, upgrade to the latest framework version, configure the OTLP exporter, and remove the old instrumentation agents. Most teams complete the migration in a sprint or two.`}];e.s(["getAllTags",0,function(){let e=new Set;return t.forEach(t=>t.tags.forEach(t=>e.add(t))),Array.from(e)},"getPostsByTag",0,function(e){return t.filter(t=>t.tags.includes(e))},"posts",0,t])},6528,e=>{"use strict";var t=e.i(18050),i=e.i(71645),a=e.i(46932);e.i(47167);var r=e.i(31178),o=e.i(47414),n=e.i(74008),s=e.i(21476),l=e.i(72846),c=i,d=e.i(37806);function p(e,t){if("function"==typeof e)return e(t);null!=e&&(e.current=t)}class u extends c.Component{getSnapshotBeforeUpdate(e){let t=this.props.childRef.current;if((0,l.isHTMLElement)(t)&&e.isPresent&&!this.props.isPresent&&!1!==this.props.pop){let e=t.offsetParent,i=(0,l.isHTMLElement)(e)&&e.offsetWidth||0,a=(0,l.isHTMLElement)(e)&&e.offsetHeight||0,r=getComputedStyle(t),o=this.props.sizeRef.current;o.height=parseFloat(r.height),o.width=parseFloat(r.width),o.top=t.offsetTop,o.left=t.offsetLeft,o.right=i-o.width-o.left,o.bottom=a-o.height-o.top}return null}componentDidUpdate(){}render(){return this.props.children}}function h({children:e,isPresent:a,anchorX:r,anchorY:o,root:n,pop:s}){let l=(0,c.useId)(),m=(0,c.useRef)(null),g=(0,c.useRef)({width:0,height:0,top:0,left:0,right:0,bottom:0}),{nonce:f}=(0,c.useContext)(d.MotionConfigContext),y=function(...e){return i.useCallback(function(...e){return t=>{let i=!1,a=e.map(e=>{let a=p(e,t);return i||"function"!=typeof a||(i=!0),a});if(i)return()=>{for(let t=0;t<a.length;t++){let i=a[t];"function"==typeof i?i():p(e[t],null)}}}}(...e),e)}(m,e.props?.ref??e?.ref);return(0,c.useInsertionEffect)(()=>{let{width:e,height:t,top:i,left:c,right:d,bottom:p}=g.current;if(a||!1===s||!m.current||!e||!t)return;let u="left"===r?`left: ${c}`:`right: ${d}`,h="bottom"===o?`bottom: ${p}`:`top: ${i}`;m.current.dataset.motionPopId=l;let y=document.createElement("style");f&&(y.nonce=f);let b=n??document.head;return b.appendChild(y),y.sheet&&y.sheet.insertRule(`
        ...
        `),()=>{m.current?.removeAttribute("data-motion-pop-id"),b.contains(y)&&b.removeChild(y)}},[a]),(0,t.jsx)(u,{isPresent:a,childRef:m,sizeRef:g,pop:s,children:!1===s?e:c.cloneElement(e,{ref:y})})}let m=({children:e,initial:a,isPresent:r,onExitComplete:n,custom:l,presenceAffectsLayout:c,mode:d,anchorX:p,anchorY:u,root:m})=>{let f=(0,o.useConstant)(g),y=(0,i.useId)(),b=!0,w=(0,i.useMemo)(()=>(b=!1,{id:y,initial:a,isPresent:r,custom:l,onExitComplete:e=>{for(let t of(f.set(e,!0),f.values()))if(!t)return;n&&n()},register:e=>(f.set(e,!1),()=>f.delete(e))}),[r,f,n]);return c&&b&&(w={...w}),(0,i.useMemo)(()=>{f.forEach((e,t)=>f.set(t,!1))},[r]),i.useEffect(()=>{r||f.size||!n||n()},[r]),e=(0,t.jsx)(h,{pop:"popLayout"===d,isPresent:r,anchorX:p,anchorY:u,root:m,children:e}),(0,t.jsx)(s.PresenceContext.Provider,{value:w,children:e})};function g(){return new Map}var f=e.i(64978);let y=e=>e.key||"";function b(e){let t=[];return i.Children.forEach(e,e=>{(0,i.isValidElement)(e)&&t.push(e)}),t}let w=({children:e,custom:a,initial:s=!0,onExitComplete:l,presenceAffectsLayout:c=!0,mode:d="sync",propagate:p=!1,anchorX:u="left",anchorY:h="top",root:g})=>{let[w,v]=(0,f.usePresence)(p),x=(0,i.useMemo)(()=>b(e),[e]),T=p&&!w?[]:x.map(y),S=(0,i.useRef)(!0),A=(0,i.useRef)(x),P=(0,o.useConstant)(()=>new Map),k=(0,i.useRef)(new Set),[C,I]=(0,i.useState)(x),[R,W]=(0,i.useState)(x);(0,n.useIsomorphicLayoutEffect)(()=>{S.current=!1,A.current=x;for(let e=0;e<R.length;e++){let t=y(R[e]);T.includes(t)?(P.delete(t),k.current.delete(t)):!0!==P.get(t)&&P.set(t,!1)}},[R,T.length,T.join("-")]);let M=[];if(x!==C){let e=[...x];for(let t=0;t<R.length;t++){let i=R[t],a=y(i);T.includes(a)||(e.splice(t,0,i),M.push(i))}return"wait"===d&&M.length&&(e=M),W(b(e)),I(x),null}let{forceRender:L}=(0,i.useContext)(r.LayoutGroupContext);return(0,t.jsx)(t.Fragment,{children:R.map(e=>{let i=y(e),r=(!p||!!w)&&(x===R||T.includes(i));return(0,t.jsx)(m,{isPresent:r,initial:(!S.current||!!s)&&void 0,custom:a,presenceAffectsLayout:c,mode:d,root:g,onExitComplete:r?void 0:()=>{if(k.current.has(i)||!P.has(i))return;k.current.add(i),P.set(i,!0);let e=!0;P.forEach(t=>{t||(e=!1)}),e&&(L?.(),W(A.current),p&&v?.(),l&&l())},anchorX:u,anchorY:h,children:e},i)})})};var v=e.i(30179);e.s(["default",0,function(){let[e,r]=(0,i.useState)(""),[o,n]=(0,i.useState)(null),s=(0,i.useMemo)(()=>(0,v.getAllTags)(),[]),l=(0,i.useMemo)(()=>v.posts.filter(t=>{let i=""===e||t.title.toLowerCase().includes(e.toLowerCase())||t.excerpt.toLowerCase().includes(e.toLowerCase())||t.content.toLowerCase().includes(e.toLowerCase()),a=!o||t.tags.includes(o);return i&&a}),[e,o]);return(0,t.jsx)("div",{className:"min-h-screen py-20 px-6",children:(0,t.jsxs)("div",{className:"max-w-4xl mx-auto",children:[(0,t.jsx)(a.motion.h1,{className:"text-5xl font-bold mb-8 bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent",initial:{opacity:0,y:20},animate:{opacity:1,y:0},children:"All Posts"}),(0,t.jsx)(a.motion.div,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{delay:.1},className:"mb-6",children:(0,t.jsxs)("div",{className:"relative",children:[(0,t.jsx)("svg",{className:"absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-500",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,t.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"})}),(0,t.jsx)("input",{type:"text",placeholder:"Search posts...",value:e,onChange:e=>r(e.target.value),className:"w-full pl-12 pr-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/50 transition-all"}),e&&(0,t.jsx)("button",{onClick:()=>r(""),className:"absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 hover:text-white transition-colors",children:"✕"})]})}),(0,t.jsxs)(a.motion.div,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{delay:.15},className:"mb-8 flex flex-wrap gap-2",children:[(0,t.jsx)("button",{onClick:()=>n(null),className:`text-sm px-3 py-1.5 rounded-full transition-all ${!o?"bg-blue-500 text-white":"bg-white/5 text-gray-400 hover:bg-white/10 hover:text-white"}`,children:"All"}),s.map(e=>(0,t.jsx)("button",{onClick:()=>n(o===e?null:e),className:`text-sm px-3 py-1.5 rounded-full transition-all ${o===e?"bg-purple-500 text-white":"bg-white/5 text-gray-400 hover:bg-white/10 hover:text-white"}`,children:e},e))]}),(0,t.jsxs)(a.motion.p,{initial:{opacity:0},animate:{opacity:1},transition:{delay:.2},className:"text-gray-500 text-sm mb-6",children:[l.length," ",1===l.length?"post":"posts"," ",e||o?"found":"total"]}),(0,t.jsx)(w,{mode:"popLayout",children:(0,t.jsx)("div",{className:"space-y-6",children:l.map((e,i)=>(0,t.jsxs)(a.motion.a,{href:`/my-app/posts/${e.slug}`,layout:!0,initial:{opacity:0,x:-20},animate:{opacity:1,x:0},exit:{opacity:0,x:20},transition:{delay:.05*i,duration:.3},className:"block group relative overflow-hidden rounded-xl border border-white/10 bg-white/5 p-6 hover:border-blue-500/50 transition-all",whileHover:{x:10},children:[(0,t.jsx)("div",{className:"absolute inset-0 bg-gradient-to-r from-blue-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"}),(0,t.jsxs)("div",{className:"relative flex justify-between items-start",children:[(0,t.jsxs)("div",{children:[(0,t.jsx)("div",{className:"flex gap-2 mb-3",children:e.tags.map(e=>(0,t.jsx)("span",{className:"text-xs px-2 py-1 rounded-full bg-purple-500/20 text-purple-300",children:e},e))}),(0,t.jsx)("h2",{className:"text-2xl font-semibold mb-2 group-hover:text-blue-400 transition-colors",children:e.title}),(0,t.jsx)("p",{className:"text-gray-400",children:e.excerpt})]}),(0,t.jsx)("span",{className:"text-gray-500 text-sm whitespace-nowrap ml-4",children:e.date})]})]},e.slug))})}),0===l.length&&(0,t.jsxs)(a.motion.div,{initial:{opacity:0},animate:{opacity:1},className:"text-center py-20",children:[(0,t.jsx)("p",{className:"text-gray-500 text-lg mb-2",children:"No posts found"}),(0,t.jsx)("p",{className:"text-gray-600",children:"Try a different search term or tag filter"})]})]})})}],6528)}]);