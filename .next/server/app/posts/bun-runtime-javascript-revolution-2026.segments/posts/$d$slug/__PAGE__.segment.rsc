...
The runtime wars are far from over, but Bun has proven that the JavaScript ecosystem benefits from healthy competition.4:T923,# Passkeys: …年密码消亡的真正起点
...
密码不会在一夜之间消失，但 Passkeys 的采用曲线已经越过临界点。对于新项目，现在就是集成 WebAuthn 的最佳时机。早一步拥抱无密码认证，用户就少一分凭证泄露的风险。5:Tada,# HTTP/3 and QUIC: What Every Web Developer Needs to Know in 2026
