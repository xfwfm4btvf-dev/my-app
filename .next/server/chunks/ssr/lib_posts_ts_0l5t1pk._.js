...
For existing applications, upgrade to the latest framework version, configure the OTLP exporter, and remove the old instrumentation agents. Most teams complete the migration in a sprint or two.`}];a.s(["getAllTags",0,function(){let a=new Set;return b.forEach(b=>b.tags.forEach(b=>a.add(b))),Array.from(a)},"getPostsByTag",0,function(a){return b.filter(b=>b.tags.includes(a))},"posts",0,b])}];
