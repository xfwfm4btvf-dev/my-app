...
密码不会在一夜之间消失，但 Passkeys 的采用曲线已经越过临界点。对于新项目，现在就是集成 WebAuthn 的最佳时机。早一步拥抱无密码认证，用户就少一分凭证泄露的风险。`}];a.s(["getAllTags",0,function(){let a=new Set;return b.forEach(b=>b.tags.forEach(b=>a.add(b))),Array.from(a)},"getPostsByTag",0,function(a){return b.filter(b=>b.tags.includes(a))},"posts",0,b])}];
