...
The era of hand-rolled retry logic is ending. Durable execution is becoming the default way to build reliable distributed systems.`}];a.s(["getAllTags",0,function(){let a=new Set;return b.forEach(b=>b.tags.forEach(b=>a.add(b))),Array.from(a)},"getPostsByTag",0,function(a){return b.filter(b=>b.tags.includes(a))},"posts",0,b])}];
