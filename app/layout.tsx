        ...
        <nav className="border-b border-white/10 bg-black/50 backdrop-blur-lg sticky top-0 z-50">
          <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div className="flex gap-6">
              <a href="/my-app" className="text-gray-300 hover:text-white transition-colors">Home</a>
              <a href="/my-app/posts" className="text-gray-300 hover:text-white transition-colors">Posts</a>
              <a href="/my-app/tags" className="text-gray-300 hover:text-white transition-colors">Tags</a>
              <a href="/my-app/about" className="text-gray-300 hover:text-white transition-colors">About</a>
            </div>
          </div>
        </nav>
        <main>{children}</main>
