...
export const posts: Post[] = [
  {
    slug: 'virtual-filesystems-ai-agents-2026',
    ...
    content: `AI agents are getting better at reasoning, but they still struggle with something deceptively simple: managing files. The mismatch between how agents think about data and how operating systems organize it is becoming a real bottleneck.
...
The protocol has graduated from experimental to essential. Make sure your stack reflects that.`
  ...
  {
    slug: 'passkeys-passwordless-auth-web-2026',
    title: 'Passkeys: …年密码消亡的真正起点',
    excerpt: 'Passkeys 已从实验性功能变成主流认证方式。本文解析其工作原理、浏览器支持现状，以及如何在你的项目中集成无密码登录。',
    date: '2026-05-11',
    tags: ['安全', 'WebAuthn', '身份认证', '前端'],
    content: `# Passkeys: …年密码消亡的真正起点
...
密码不会在一夜之间消失，但 Passkeys 的采用曲线已经越过临界点。对于新项目，现在就是集成 WebAuthn 的最佳时机。早一步拥抱无密码认证，用户就少一分凭证泄露的风险。`
  },
  {
    ...
    content: `# Bun Runtime: The JavaScript Engine Revolution of 2026
...
The runtime wars are far from over, but Bun has proven that the JavaScript ecosystem benefits from healthy competition.`
  ...
  {
    slug: 'mcp-security-risks-2026',
    title: 'MCP安全风险: 当AI代理成为攻击面',
    excerpt: 'Model Context Protocol正在成为AI集成的默认标准, 但其安全模型仍存在严重隐患. 本文剖析MCP的三大攻击面及防护策略.',
    date: '2026-05-11',
    tags: ['AI', 'Security', 'MCP', 'Protocol', 'DevSecOps'],
    content: `# MCP安全风险: 当AI代理成为攻击面
...
The VFS pattern is part of the shift toward standardized agent infrastructure. Just as Docker standardized app environments, virtual filesystems are standardizing how AI agents interact with data. Combined with MCP for tool discovery, we're seeing the agent OS layer emerge.`
  },
  {
    ...
    content: `# The Rise of Modular Monoliths
...
The lesson: architecture should follow team structure and business needs, not trends.`
  ...
  {
    slug: 'mcp-remote-servers-ai-interop-2026',
    ...
    content: `Model Context Protocol（MCP）在2025年底还只是一个本地工具调用协议，如今远程MCP服务器的标准化正在彻底改变AI应用的架构模式。
...
The era of AI requires a server is ending. The browser is now a legitimate AI inference platform, and early adopters are shipping features that feel magical — instant, private, and free at scale.`
...

  {
    ...
    content: `# Durable Execution: Building Reliable Workflows Without the Headache
...
WASI Preview 3 positions WebAssembly as a serious contender for cloud-native infrastructure. With native async, a verified component model, and universal portability, the gap between WASM and traditional containerized deployments is closing fast. The question isn't whether to adopt WASM for backend services — it's when.`
  },
  {
    ...
    date: '2026-05-12',
    tags: ['安全', 'AI', 'SOC', '威胁检测', '运营'],
    content: `安全运营中心（SOC）长期被一个核心问题困扰：告警疲劳。一个中型企业每天产生数万条安全告警，分析师手动筛选、关联、响应，效率极低。2026年，AI原生SOC正在改变这一局面。
...
2026年的安全运营不再是“多一个SIEM”，而是重构整个安全工作流。AI不是替代分析师，而是让他们从重复劳动中解放，专注于真正需要人类判断的复杂威胁。`
  },
  ];
