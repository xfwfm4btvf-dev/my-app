...
The question is no longer "should we run AI locally?" It is "why are we still sending everything to the cloud?"`}];e.s(["getAllTags",0,function(){let e=new Set;return t.forEach(t=>t.tags.forEach(t=>e.add(t))),Array.from(e)},"getPostsByTag",0,function(e){return t.filter(t=>t.tags.includes(e))},"posts",0,t])},32796,e=>{"use strict";var t=e.i(18050),a=e.i(46932),r=e.i(30179),i=e.i(8027),s=e.i(49302);e.s(["default",0,function(){let e=(0,r.getAllTags)();return(0,t.jsxs)("div",{className:"min-h-screen relative",children:[(0,t.jsx)(i.Particles,{className:"absolute inset-0",quantity:50,color:"#ffffff"}),(0,t.jsx)("div",{className:"relative py-20 px-6 z-10",children:(0,t.jsxs)("div",{className:"max-w-6xl mx-auto",children:[(0,t.jsxs)(a.motion.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},className:"text-center mb-16",children:[(0,t.jsx)("h1",{className:"text-5xl md:text-6xl font-bold mb-4 bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent",children:"Tags"}),(0,t.jsx)("p",{className:"text-gray-400",children:"Browse posts by topic"})]}),(0,t.jsx)("div",{className:"grid md:grid-cols-2 lg:grid-cols-3 gap-6",children:e.map((e,i)=>{let o=(0,r.getPostsByTag)(e);return(0,t.jsxs)(a.motion.div,{className:"relative group rounded-2xl border border-white/10 bg-black/50 backdrop-blur-sm p-6 hover:border-purple-500/50 transition-all duration-300 overflow-hidden",initial:{opacity:0,scale:.9},animate:{opacity:1,scale:1},transition:{delay:.1*i},whileHover:{scale:1.02,y:-5},children:[(0,t.jsx)("div",{className:"absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity",children:(0,t.jsx)(s.BorderBeam,{size:200,duration:8,colorFrom:"#a855f7",colorTo:"#ec4899"})}),(0,t.jsxs)("div",{className:"relative",children:[(0,t.jsxs)("div",{className:"flex items-center gap-3 mb-4",children:[(0,t.jsx)("span",{className:"text-3xl",children:"#"}),(0,t.jsx)("h2",{className:"text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent",children:e})]}),(0,t.jsxs)("p",{className:"text-gray-400 mb-4",children:[o.length," post",1!==o.length?"s":""]}),(0,t.jsx)("div",{className:"flex flex-wrap gap-2",children:o.map(e=>(0,t.jsx)("a",{href:`/my-app/posts/${e.slug}`,className:"text-sm px-3 py-1.5 rounded-full bg-white/5 text-gray-300 hover:bg-white/10 hover:text-white border border-white/5 hover:border-white/10 transition-all",children:e.title},e.slug))})]})]},e)})})]})})]})}])}]);