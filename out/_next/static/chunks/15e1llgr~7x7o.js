...
With the Component Model proposal, Wasm modules will be able to compose and interoperate across languages. Imagine importing a Rust crypto library directly into your JavaScript edge function — that future is closer than you think.`},{slug:"circuit-breaker-pattern-apis",title:"Building Resilient APIs with the Circuit Breaker Pattern",excerpt:"Prevent cascading failures in distributed systems with the circuit breaker design pattern.",date:"2026-05-11",tags:["Architecture","APIs"],content:`
...
3. **Provide meaningful fallbacks**: Return cached data or degraded functionality instead of errors.`},{slug:"rust-for-web-developers",title:"Why Web Developers Should Learn Rust in 2026",excerpt:"Rust is no longer just for systems programmers — it is becoming essential for modern web development.",date:"2026-05-10",tags:["Rust","Web Development"],content:`
...
3. **Not monitoring unused indexes**: Remove indexes that are never read.`},{slug:"css-container-queries",title:"Container Queries: The End of Media Query Hacks",excerpt:"CSS container queries let components respond to their own size, not just the viewport.",date:"2026-05-08",tags:["CSS","Frontend"],content:`
...
3. Name your containers for clarity in complex layouts`},{slug:"mastering-typescript",title:"Mastering TypeScript: A Guide to Better JavaScript",excerpt:"TypeScript has become the gold standard for building robust web applications.",date:"2026-05-10",tags:["TypeScript","JavaScript"],content:`
...
4. Type your environment variables`},{slug:"getting-started-with-nextjs",title:"Getting Started with Next.js 16",excerpt:"Next.js 16 brings exciting new features.",date:"2026-05-08",tags:["Next.js","React"],content:`
...
4. Add error.tsx for graceful error boundaries`},{slug:"ai-powered-development",title:"AI-Powered Development Tools",excerpt:"How AI assistants are transforming the way we write code.",date:"2026-05-05",tags:["AI","Productivity"],content:`
...
4. Stay in control - Use AI as a tool, not replacement`},{slug:"web-security-essentials",title:"Web Security Essentials for Modern Apps",excerpt:"Security is not optional. Learn the essential practices.",date:"2026-05-01",tags:["Security","Web"],content:`
...
5. Log security events`},{slug:"opentelemetry-observability-microservices",title:"OpenTelemetry: Unified Observability for Microservices",excerpt:"How OpenTelemetry is becoming the universal standard for traces, metrics, and logs in distributed systems.",date:"2026-05-11",tags:["Observability","DevOps"],content:`
...
4. **Start small**: Begin with auto-instrumentation, then add custom spans for business logic`},{slug:"model-context-protocol-ai-integration",title:"Model Context Protocol: AI 工具集成的新标准",excerpt:"深入解析 MCP 如何统一 AI 模型与外部工具的交互方式，以及它对开发者生态的影响。",date:"2026-05-11",tags:["AI","MCP","开发工具"],content:`
...
`},{slug:"zero-knowledge-web-auth-2026",title:"Zero-Knowledge Proofs Are Revolutionizing Web Authentication",excerpt:"How zero-knowledge proofs are eliminating password breaches and transforming how we prove identity online.",date:"2026-05-11",tags:["Security","Cryptography","Web Development","Authentication"],content:`
...
Complex client-side applications with rich interactions — real-time collaboration tools, design editors, spreadsheet apps — genuinely benefit from a component framework. The key insight is that most web applications are not in this category.`},{slug:"biome-js-linter-2026",title:"Biome: The Rust-Powered JavaScript Toolchain Replacing ESLint and Prettier",excerpt:"How Biome is consolidating linting and formatting into a single, blazingly fast tool — and why the ecosystem is embracing it.",date:"2026-05-11",tags:["JavaScript","Tooling","Rust","Developer Experience"],content:`
...
The protocol has graduated from experimental to essential. Make sure your stack reflects that.`},{slug:"passkeys-passwordless-auth-web-2026",title:"Passkeys: …年密码消亡的真正起点",excerpt:"Passkeys 已从实验性功能变成主流认证方式。本文解析其工作原理、浏览器支持现状，以及如何在你的项目中集成无密码登录。",date:"2026-05-11",tags:["安全","WebAuthn","身份认证","前端"],content:`
...
The runtime wars are far from over, but Bun has proven that the JavaScript ecosystem benefits from healthy competition.`},{slug:"mcp-security-risks-2026",title:"MCP安全风险: 当AI代理成为攻击面",excerpt:"Model Context Protocol正在成为AI集成的默认标准, 但其安全模型仍存在严重隐患. 本文剖析MCP的三大攻击面及防护策略.",date:"2026-05-11",tags:["AI","Security","MCP","Protocol","DevSecOps"],content:`
...
AI代理的便利性不应以安全性为代价. 在MCP生态成熟之前, 保持警惕是唯一的正确选择.`}];e.s(["getAllTags",0,function(){let e=new Set;return t.forEach(t=>t.tags.forEach(t=>e.add(t))),Array.from(e)},"getPostsByTag",0,function(e){return t.filter(t=>t.tags.includes(e))},"posts",0,t])},62028,e=>{"use strict";var t=e.i(18050),a=e.i(71645),i=e.i(30179);e.s(["SearchDialog",0,function(){let[e,r]=(0,a.useState)(!1),[s,n]=(0,a.useState)(""),[o,l]=(0,a.useState)([]),c=(0,a.useRef)(null),d=(0,a.useCallback)(e=>{n(e),l(function(e){if(!e.trim())return[];let t=e.toLowerCase().split(/\s+/).filter(Boolean),a=[];for(let e of i.posts){let i=0,r=e.title.toLowerCase(),s=e.excerpt.toLowerCase(),n=e.content.toLowerCase(),o=e.tags.map(e=>e.toLowerCase());for(let e of t)r.includes(e)&&(i+=10),o.some(t=>t.includes(e))&&(i+=7),s.includes(e)&&(i+=4),n.includes(e)&&(i+=1);i>0&&a.push({...e,score:i})}return a.sort((e,t)=>t.score-e.score).slice(0,8)}(e))},[]);return((0,a.useEffect)(()=>{let e=e=>{(e.metaKey||e.ctrlKey)&&"k"===e.key&&(e.preventDefault(),r(!0)),"Escape"===e.key&&(r(!1),n(""),l([]))};return window.addEventListener("keydown",e),()=>window.removeEventListener("keydown",e)},[]),(0,a.useEffect)(()=>{e&&setTimeout(()=>c.current?.focus(),100)},[e]),e)?(0,t.jsxs)("div",{className:"fixed inset-0 z-[100] flex items-start justify-center pt-[15vh]",children:[(0,t.jsx)("div",{className:"absolute inset-0 bg-black/70 backdrop-blur-sm",onClick:()=>{r(!1),n(""),l([])}}),(0,t.jsxs)("div",{className:"relative w-full max-w-xl mx-4 bg-gray-900 border border-white/10 rounded-2xl shadow-2xl overflow-hidden",children:[(0,t.jsxs)("div",{className:"flex items-center gap-3 px-4 py-3 border-b border-white/10",children:[(0,t.jsx)("svg",{className:"w-5 h-5 text-gray-400 flex-shrink-0",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,t.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"})}),(0,t.jsx)("input",{ref:c,type:"text",value:s,onChange:e=>d(e.target.value),placeholder:"Search posts by title, tag, or keyword...",className:"flex-1 bg-transparent text-white placeholder-gray-500 outline-none text-base"}),(0,t.jsx)("button",{onClick:()=>{r(!1),n(""),l([])},className:"px-2 py-1 text-xs text-gray-400 bg-white/10 rounded-md hover:bg-white/20 transition-colors",children:"ESC"})]}),(0,t.jsx)("div",{className:"max-h-[400px] overflow-y-auto",children:""===s.trim()?(0,t.jsxs)("div",{className:"px-4 py-8 text-center text-gray-500",children:[(0,t.jsxs)("p",{className:"text-sm",children:["Type to search through ",i.posts.length," articles"]}),(0,t.jsx)("p",{className:"text-xs mt-1 text-gray-600",children:"Search by title, tags, or content keywords"})]}):0===o.length?(0,t.jsx)("div",{className:"px-4 py-8 text-center text-gray-500",children:(0,t.jsx)("p",{className:"text-sm",children:"No results found"})}):(0,t.jsx)("div",{className:"py-2",children:o.map(e=>(0,t.jsx)("a",{href:`/my-app/posts/${e.slug}`,className:"block px-4 py-3 hover:bg-white/5 transition-colors",onClick:()=>{r(!1),n(""),l([])},children:(0,t.jsxs)("div",{className:"flex items-start justify-between gap-2",children:[(0,t.jsxs)("div",{className:"flex-1 min-w-0",children:[(0,t.jsx)("h4",{className:"text-white font-medium truncate",children:e.title}),(0,t.jsx)("p",{className:"text-sm text-gray-400 mt-0.5 line-clamp-1",children:e.excerpt}),(0,t.jsxs)("div",{className:"flex items-center gap-2 mt-1.5",children:[(0,t.jsx)("span",{className:"text-xs text-gray-500",children:e.date}),e.tags.slice(0,3).map(e=>(0,t.jsx)("span",{className:"text-xs px-1.5 py-0.5 rounded bg-blue-500/10 text-blue-400",children:e},e))]})]}),(0,t.jsx)("svg",{className:"w-4 h-4 text-gray-600 flex-shrink-0 mt-1",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,t.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})]})},e.slug))})}),(0,t.jsxs)("div",{className:"px-4 py-2 border-t border-white/10 flex items-center justify-between text-xs text-gray-600",children:[(0,t.jsx)("span",{children:o.length>0?`${o.length} results`:""}),(0,t.jsx)("span",{children:"Nitrogen Search"})]})]})]}):(0,t.jsxs)("button",{onClick:()=>r(!0),className:"flex items-center gap-2 px-3 py-1.5 rounded-lg border border-white/10 bg-white/5 hover:bg-white/10 transition-colors text-gray-400 text-sm",title:"Search (Ctrl+K)",children:[(0,t.jsx)("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,t.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"})}),(0,t.jsx)("span",{className:"hidden sm:inline",children:"Search..."}),(0,t.jsx)("kbd",{className:"hidden sm:inline-flex items-center gap-1 px-1.5 py-0.5 text-xs bg-white/10 rounded border border-white/10",children:"Ctrl+K"})]})}])},71691,e=>{"use strict";var t=e.i(18050),a=e.i(71645);e.s(["BackToTop",0,function(){let[e,i]=(0,a.useState)(!1);return((0,a.useEffect)(()=>{let e=()=>{i(window.scrollY>300)};return window.addEventListener("scroll",e),()=>window.removeEventListener("scroll",e)},[]),e)?(0,t.jsx)("button",{onClick:()=>{window.scrollTo({top:0,behavior:"smooth"})},"aria-label":"Back to top",className:"fixed bottom-8 right-8 z-50 p-3 rounded-full bg-blue-600 text-white shadow-lg hover:bg-blue-700 transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2",children:(0,t.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:(0,t.jsx)("polyline",{points:"18 15 12 9 6 15"})})}):null}])},56691,e=>{"use strict";var t=e.i(18050);e.s(["Footer",0,function(){let e=new Date().getFullYear(),a=[{label:"GitHub",href:"https://github.com/xfwfm4btvf-dev",icon:(0,t.jsx)("svg",{className:"w-5 h-5",fill:"currentColor",viewBox:"0 0 24 24",children:(0,t.jsx)("path",{d:"M12 0C5.374 0 0 5.373 0 12c0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23A11.509 11.509 0 0112 5.803c1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576C20.566 21.797 24 17.3 24 12c0-6.627-5.373-12-12-12z"})})},{label:"Twitter",href:"https://twitter.com/nitrogen_blog",icon:(0,t.jsx)("svg",{className:"w-5 h-5",fill:"currentColor",viewBox:"0 0 24 24",children:(0,t.jsx)("path",{d:"M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"})})}];return(0,t.jsxs)("footer",{className:"relative border-t border-white/10 bg-black/80 backdrop-blur-sm",children:[(0,t.jsx)("div",{className:"absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-blue-500/50 to-transparent"}),(0,t.jsxs)("div",{className:"max-w-6xl mx-auto px-6 py-12",children:[(0,t.jsxs)("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-8",children:[(0,t.jsxs)("div",{children:[(0,t.jsx)("a",{href:"/my-app",className:"text-2xl font-bold bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent",children:"Nitrogen"}),(0,t.jsx)("p",{className:"text-gray-500 text-sm mt-3 max-w-xs",children:"Exploring tech, code, and the future. In-depth articles on web development, DevOps, architecture, and emerging technologies."})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("h3",{className:"text-sm font-semibold text-gray-300 uppercase tracking-wider mb-4",children:"Navigate"}),(0,t.jsx)("ul",{className:"space-y-2",children:[{label:"Home",href:"/my-app"},{label:"Posts",href:"/my-app/posts"},{label:"Tags",href:"/my-app/tags"},{label:"About",href:"/my-app/about"},{label:"RSS",href:"/my-app/rss.xml"}].map(e=>(0,t.jsx)("li",{children:(0,t.jsx)("a",{href:e.href,target:e.href.startsWith("http")?"_blank":void 0,rel:e.href.startsWith("http")?"noopener noreferrer":void 0,className:"text-gray-400 hover:text-white transition-colors text-sm",children:e.label})},e.label))})]}),(0,t.jsxs)("div",{children:[(0,t.jsx)("h3",{className:"text-sm font-semibold text-gray-300 uppercase tracking-wider mb-4",children:"Connect"}),(0,t.jsx)("div",{className:"flex gap-4",children:a.map(e=>(0,t.jsx)("a",{href:e.href,target:"_blank",rel:"noopener noreferrer","aria-label":e.label,className:"text-gray-400 hover:text-white transition-colors p-2 rounded-lg hover:bg-white/5",children:e.icon},e.label))}),(0,t.jsx)("div",{className:"mt-6",children:(0,t.jsxs)("a",{href:"/my-app/rss.xml",target:"_blank",rel:"noopener noreferrer",className:"inline-flex items-center gap-2 text-sm text-gray-400 hover:text-orange-400 transition-colors",children:[(0,t.jsx)("svg",{className:"w-4 h-4",fill:"currentColor",viewBox:"0 0 24 24",children:(0,t.jsx)("path",{d:"M6.18 15.64a2.18 2.18 0 0 1 2.18 2.18C8.36 19.01 7.38 20 6.18 20C4.98 20 4 19.01 4 17.82a2.18 2.18 0 0 1 2.18-2.18M4 4.44A15.56 15.56 0 0 1 19.56 20h-2.83A12.73 12.73 0 0 0 4 7.27V4.44m0 5.66a9.9 9.9 0 0 1 9.9 9.9h-2.83A7.07 7.07 0 0 0 4 12.93V10.1z"})}),"Subscribe via RSS"]})})]})]}),(0,t.jsxs)("div",{className:"mt-12 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4",children:[(0,t.jsxs)("p",{className:"text-gray-600 text-xs",children:["© ",e," Nitrogen Blog. All rights reserved."]}),(0,t.jsxs)("p",{className:"text-gray-600 text-xs flex items-center gap-1",children:["Built with",(0,t.jsx)("svg",{className:"w-3 h-3 text-red-400",fill:"currentColor",viewBox:"0 0 24 24",children:(0,t.jsx)("path",{d:"M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"})}),"using Next.js & Tailwind CSS"]})]})]})]})}])}]);